...
for i in range(len(ubvis)):
    ...
    fkl_ubvi[i,:] = kldiv(mus, Sigs, wts, logp, np.random.standard_cauchy, direction='forward')
    rkl_ubvi[i,:] = kldiv(mus, Sigs, wts, logp, np.random.standard_cauchy, direction='reverse')
    cput_ubvi[i,:] = cput
    ...
    fkl_bbvi[i,:] = kldiv(mus, Sigs, wts, logp, np.random.standard_cauchy, direction='forward')
    rkl_bbvi[i,:] = kldiv(mus, Sigs, wts, logp, np.random.standard_cauchy, direction='reverse')
    cput_bbvi[i,:] = cput
    ...
    fkl_bbvi2[i,:] = kldiv(mus, Sigs, wts, logp, np.random.standard_cauchy, direction='forward')
    rkl_bbvi2[i,:] = kldiv(mus, Sigs, wts, logp, np.random.standard_cauchy, direction='reverse')
    cput_bbvi2[i,:] = cput
