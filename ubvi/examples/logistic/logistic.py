...
print('Synth UBVI')
ubvi_synth = ubvi(logf_synth, N, d_synth, Diag, n_samples, n_logfg_samples, adam_learning_rate, adam_num_iters, n_init=n_init)
print('Synth BBVI')
bbvi_synth = bbvi(logp_synth, N, d_synth, Diag, n_samples, lmb, adam_learning_rate, adam_num_iters, n_init)
print('Synth ADVI')
advi_synth = bbvi(logp_synth, 1, d_synth, Diag, n_samples, lmb1, adam_learning_rate, adam_num_iters, n_init)
...
print('DS1 UBVI')
ubvi_ds1 = ubvi(logf_ds1, N, d_ds1, Diag, n_samples, n_logfg_samples, adam_learning_rate, adam_num_iters, n_init=n_init)
print('DS1 BBVI')
bbvi_ds1 = bbvi(logp_ds1, N, d_ds1, Diag, n_samples, lmb, adam_learning_rate, adam_num_iters, n_init)
print('DS1 ADVI')
advi_ds1 = bbvi(logp_ds1, 1, d_ds1, Diag, n_samples, lmb1, adam_learning_rate, adam_num_iters, n_init)
...
print('PHISH UBVI')
ubvi_phish = ubvi(logf_phish, N, d_phish, Diag, n_samples, n_logfg_samples, adam_learning_rate, adam_num_iters, n_init=n_init)
print('PHISH BBVI')
bbvi_phish = bbvi(logp_phish, N, d_phish, Diag, n_samples, lmb, adam_learning_rate, adam_num_iters, n_init)
print('PHISH ADVI')
advi_phish = bbvi(logp_phish, 1, d_phish, Diag, n_samples, lmb1, adam_learning_rate, adam_num_iters, n_init)
